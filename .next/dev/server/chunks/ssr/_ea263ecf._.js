...
function AllProgramsPage() {
    ...
    const fetchAllPrograms = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/programs'); // Assuming backend has an endpoint to get all programs
            if (res.data.success) {
...
//# sourceMappingURL=_ea263ecf._.js.map