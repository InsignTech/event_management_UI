...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', formData);
            if (res.data.success) {
...
//# sourceMappingURL=_c221f87c._.js.map