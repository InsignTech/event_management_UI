...
function AllProgramsPage() {
    ...
    const fetchAllPrograms = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/programs'); // Assuming backend has an endpoint to get all programs
            if (res.data.success) {
    ...
    const filteredPrograms = programs.filter((p)=>p.name.toLowerCase().includes(searchTerm.toLowerCase()) || p.event?.name.toLowerCase().includes(searchTerm.toLowerCase()));
...
_s(AllProgramsPage, "iDvEkMuOBlMsrIHiGEyADjBpF6U=");
_c = AllProgramsPage;
var _c;
...
//# sourceMappingURL=_893262e0._.js.map