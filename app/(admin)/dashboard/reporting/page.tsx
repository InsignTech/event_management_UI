...
export default function ReportingLandingPage() {
    ...
    return (
        <RoleProtected allowedRoles={['super_admin', 'event_admin', 'coordinator', 'program_reporting']}>
            <div className="space-y-6 font-sans">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-black tracking-tight">Program Reporting</h1>
                        <p className="text-sm text-muted-foreground mt-1">Select a college to manage reporting and participation</p>
                    </div>
                </div>
                                    ...
                                    filteredColleges.map((college) => (
                                        <tr key={college._id} className="hover:bg-muted/30 transition-colors group">
                                            ...
                                            <td className="px-6 py-5 text-right">
                                                <Link 
                                                    href={`/dashboard/reporting/${college._id}`}
